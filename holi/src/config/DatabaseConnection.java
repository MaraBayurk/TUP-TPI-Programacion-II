...
public class DatabaseConnection {
    ...
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/db_veterinaria_tfi?serverTimezone=UTC&useSSL=false";
    private static final String USER = "root";
    private static final String PASSWORD = "Ronaldweasley.2"; // si root tiene contraseña, ponela acá
